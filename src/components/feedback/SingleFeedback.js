...
const SingleFeedback = ({ singleFeedback, deleteFeedback, user }) => {
  ...
  return (
    <div className='row w-100 text-light mx-0 my-4 rounded-4 overflow-hidden' style={{height: '200px'}}>
      <div className='col-2 fs-4 px-0 pt-4 d-inline text-center outer' style={{'min-width': '120px'}}>
